  ...
  <nav class="navbar">
    <div class="container">
      ...
      <div class="navbar-menu" :class="{ 'is-active': isMobileMenuOpen }">
        ...
        <router-link :to="{ path: '/add-subject', query: route.query }" class="navbar-item"
          @click="isMobileMenuOpen = false">Add
          Subject</router-link>
        <router-link :to="{ path: '/upload-document', query: route.query }" class="navbar-item"
          @click="isMobileMenuOpen = false">Upload
          Document</router-link>
        <router-link :to="{ path: '/document-info', query: route.query }" class="navbar-item"
